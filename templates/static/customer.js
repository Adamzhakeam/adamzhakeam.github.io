document.addEventListener('DOMContentLoaded', () => {
    ...
    registerCustomerForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch('https://acutiva.duckdns.org/registerCustomer', {
                method: 'POST',
                headers: {
    ...
    fetchCustomerForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch('https://acutiva.duckdns.org/fetchSpecificCustomer', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function fetchAllCustomers() {
        try {
            const response = await fetch('https://acutiva.duckdns.org/fetchAllCustomers', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                }
