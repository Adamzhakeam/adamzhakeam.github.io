...
document.getElementById('fetchAllSalesBtn').addEventListener('click', () => {
    fetchSales('https://acutiva.duckdns.org/fetchAllSalesReports');
});

document.getElementById('fetchSpecificDateBtn').addEventListener('click', () => {
    const date = prompt('Enter the date (YYYY-MM-DD):');
    if (date) {
        fetchSales('https://acutiva.duckdns.org/fetchSpecificSalesReports', { saleDate: date });
    }
});
...
document.getElementById('fetchSalesFromToBtn').addEventListener('click', () => {
    ...
    if (startDate && endDate) {
        fetchSales('https://acutiva.duckdns.org/fetchSpecificSalesFromToReports', { dateFrom: startDate, dateTo: endDate });
    }
});
...
document.getElementById('generateCSVBtn').addEventListener('click', () => {
    ...
    switch (dateRange) {
        case 'today':
            ...
            endpoint = 'https://acutiva.duckdns.org/fetchSpecificSalesReports';
        ...
        case 'thisWeek':
            ...
            endpoint = 'https://acutiva.duckdns.org/fetchSpecificSalesFromToReports';
