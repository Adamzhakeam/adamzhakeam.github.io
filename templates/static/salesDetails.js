document.addEventListener('DOMContentLoaded', () => {
    ...
    fetchSales('https://acutiva.duckdns.org/fetchAllSales');
    ...
    fetchSpecificSalesBtn.addEventListener('click', () => {
        ...
        if (saleDate) {
            fetchSales('https://acutiva.duckdns.org/fetchSpecificSales', { saleDate: saleDate });
        }
    });
    ...
    fetchSalesFromToBtn.addEventListener('click', () => {
        ...
        if (dateFrom && dateTo) {
            fetchSales('https://acutiva.duckdns.org/fetchSpecificSalesFromTo', { dateFrom: dateFrom, dateTo: dateTo });
        }
    });
    ...
    salesFilterDropdown.addEventListener('change', (event) => {
        ...
        if (filterOption === 'today') {
            ...
            fetchSales('https://acutiva.duckdns.org/fetchSpecificSales', { saleDate: today });
