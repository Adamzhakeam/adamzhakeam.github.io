document.addEventListener('DOMContentLoaded', () => {
    ...
    fetchSales('http://192.168.137.156:5000/fetchAllSales');
    ...
    fetchSpecificSalesBtn.addEventListener('click', () => {
        ...
        if (saleDate) {
            fetchSales('http://192.168.137.156:5000/fetchSpecificSales', { saleDate: saleDate });
        }
    });
    ...
    fetchSalesFromToBtn.addEventListener('click', () => {
        ...
        if (dateFrom && dateTo) {
            fetchSales('http://192.168.137.156:5000/fetchSpecificSalesFromTo', { dateFrom: dateFrom, dateTo: dateTo });
        }
    });
    ...
    salesFilterDropdown.addEventListener('change', (event) => {
        ...
        if (filterOption === 'today') {
            ...
            fetchSales('http://192.168.137.156:5000/fetchSpecificSales', { saleDate: today });
