...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function fetchTotalAmountPaid() {
    fetch('http://192.168.137.156:5000/fetchAllSales', {
        method: 'POST',
        headers: {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function fetchTotalAmountSold() {
    fetch('http://192.168.137.156:5000/fetchAllProductSales', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function fetchProductsWithWarningStock() {
    fetch('http://192.168.137.156:5000/fetchAllProductsWithWarningStock', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        }
...
function fetchDebtorsData() {
    fetch('http://192.168.137.156:5000/fetchAllUnclearedCredits', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        }
