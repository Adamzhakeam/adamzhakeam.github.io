...
async function fetchAllProducts(page) {
    try {
        const response = await fetch('http://192.168.137.156:5000/fetchAllProducts', {
            method: 'POST',
            headers: {
...
async function searchProducts() {
    ...
    if (searchType === 'name') {
        endpoint = 'http://192.168.137.156:5000/fetchSpecificProduct';
        payload = { productName: query };
    } else if (searchType === 'serialNumber') {
        endpoint = 'http://192.168.137.156:5000/fetchSpecificProductByPertNumber';
        payload = { productSerialNumber: query };
    } else if (searchType === 'category') {
        endpoint = 'http://192.168.137.156:5000/fetchSpecificProductByCategory';
...
async function openEditModal(productId) {
    ...
    try {
        const response = await fetch('http://192.168.137.156:5000/fetchSpecificProductById', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function updateProduct(event) {
    ...
    try {
        const response = await fetch('http://192.168.137.156:5000/editProduct', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
